    ...
    return (
        <div className="w-full bg-white flex flex-col items-center py-24 px-4 box-border">
            <section className="w-full max-w-7xl flex flex-col items-center relative text-center text-gray-900 font-sans">
                {/* Header */}
                <div className={`flex flex-col items-center justify-center mb-16 max-w-4xl z-10 ${variant === "home" ? "pt-[38px] gap-[61px]" : "gap-4"
                    }`}>
                    <h2 className="m-0 relative text-2xl md:text-3xl tracking-[-0.02em] leading-tight font-bold text-gray-900">
                        {renderMoreHighlightedText(activeHeading)}
                    </h2>
                    {activeSubtitle && (
                        <h3 className="m-0 relative text-lg md:text-xl tracking-tight pb-[70px] leading-relaxed font-medium text-gray-800 max-w-[589px]">
