...
export const StoryDetail: React.FC<StoryDetailProps> = ({ 
  ...
  // Simple helper to detect if a link is likely a video
        ...
        <div className="max-w-3xl mx-auto">
          {isPreview ? (
            <div className="flex justify-between items-center mb-12">
               <button 
                 onClick={onBack}
                 className="text-stone-500 text-xs font-bold uppercase tracking-widest hover:text-stone-900 transition-colors flex items-center"
               >
               ...
               <div className="flex space-x-4">
                 <button 
                   onClick={onSaveDraft}
                   className="px-6 py-2.5 border border-stone-200 text-stone-900 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-stone-50 transition-all"
                 >
                   Save as Draft
                 </button>
                 <button 
                   onClick={onPublish}
                   className="px-6 py-2.5 bg-amber-600 text-white rounded-full text-xs font-bold uppercase tracking-widest hover:bg-amber-700 transition-all"
                 >
                   Publish Post
                 </button>
               </div>
          ...
          {!isPreview && (
            <div className="mt-24 text-center">
              <button 
                onClick={() => setView('stories')}
                className="px-8 py-4 bg-stone-900 text-white rounded-full font-bold text-sm hover:bg-stone-800 transition-all uppercase tracking-widest"
              >
