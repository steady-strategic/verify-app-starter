...
const Cards3x1: NextPage<Cards3x1Type> = ({ className = "" }) => {
  ...
  return (
    <div className={`max-w-full flex flex-col items-start ${className}`}>
      <section className="w-[1440px] h-[750px] bg-white overflow-hidden shrink-0 flex flex-col items-center pt-[77px] px-[0px] pb-[84px] box-border text-center text-[28px] text-primary-1 font-[Inter]">
