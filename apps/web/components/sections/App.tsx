...
export const App: React.FC<AppSectionProps> = ({
    ...
    return (
        <div className={`relative w-screen left-1/2 -translate-x-1/2 min-h-[1050px] overflow-hidden ${className}`}>
            {/* Background Layer */}
            <div className="absolute inset-0 w-full h-full">
                {/* Background Image */}
                <div className="absolute top-0 left-0 w-full h-[921px]">
                    <Image
                        src="/assets/images/App/DownloadApp-BG.png"
                        alt="App background"
                        fill
