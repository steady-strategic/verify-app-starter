...
export const AppFeature: React.FC<AppFeatureProps> = ({ setView }) => {
  return (
        ...
        <div className="grid md:grid-cols-2 gap-20 items-center">
          ...
          <div className="order-1 md:order-2 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
              <button 
                onClick={() => setView('app')}
                className="w-full sm:w-auto px-8 py-4 bg-amber-600 text-white rounded-full font-semibold text-sm shadow-lg shadow-amber-100 hover:bg-amber-700 hover:shadow-xl transition-all"
              >
